...
public class CustomEntityAttributes {
    ...
    public static final EntityAttribute CRIT_DAMAGE = register("generic.crit_damage", new ClampedEntityAttribute("attribute.name.generic.crit_damage", 1.5D, 0.0D, 100D).setTracked(true));
